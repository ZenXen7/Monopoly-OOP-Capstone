...
public class Board extends JPanel {
    ...
    private void initializeSquares() {
        ...
        Square square01 = new Square(106,6,100,100,squareNames[1],0);
        this.add(square01);
        allSquares.add(square01);

        Square square02 = new Square(206,6,100,100,squareNames[2],0);
        this.add(square02);
        allSquares.add(square02);
        unbuyableSquares.add(square02);

        Square square03 = new Square(306,6,100,100,squareNames[3],0);
        this.add(square03);
        allSquares.add(square03);

        Square square04 = new Square(406,6,100,100,squareNames[4],0);
        this.add(square04);
